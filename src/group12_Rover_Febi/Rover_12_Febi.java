...
public class Rover_12_Febi {	
	...
	public Rover_12_Febi(String serverAddress) {
		// constructor
		System.out.println("ROVER_12 rover object constructed");
		rovername = "ROVER_12";
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			//System.out.println("ROVER_12 equipment list results drive " + equipment.get(0));
	...
	public static void main(String[] args) throws Exception {
		Rover_12_Febi client = new Rover_12_Febi();
		client.run();
	}
